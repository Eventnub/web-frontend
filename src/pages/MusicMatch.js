    ...
    <Page title="Music Match">
      {isMatch ? (
        <Stack alignItems="center" sx={{ height: '100vh', px: '1rem' }}>
          ...
          >
            <Typography sx={{ color: '#000', fontWeight: '200', fontSize: '1.4rem', mt: '1rem', textAlign: 'center' }}>
              Music Match
            </Typography>
          ...
          <Box sx={{ height: '90%', width: '75%', display: 'flex', gap: '2rem' }}>
            ...
            >
              ...
              <Box sx={{ m: 'auto', height: '35%', width: '50%', margin: 'auto', mt: '.5rem' }}>
                <VoiceRecorder musicMatchId={musicMatch?.uid} isTimeElapsed={isTimeElapsed} />
              </Box>
            </Box>
          </Box>
        </Container>
      )}
      <MusicMatchInfoDialog
        open={musicMatchInfoDialogShown}
